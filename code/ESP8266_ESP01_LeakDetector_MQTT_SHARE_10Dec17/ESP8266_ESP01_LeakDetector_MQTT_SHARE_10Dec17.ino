...
const char *ssid = "YOUR-SSID-HERE"; //change with your Wi-Fi SSID
const char *password = "YOUR-SSID-PASSWORD-HERE"; //change with your Wi-Fi SSID password
const char *mqtt_server = "broker.mqtt-dashboard.com"; //Server credentials
